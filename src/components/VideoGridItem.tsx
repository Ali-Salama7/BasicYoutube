  ...
  return (
    <div className="flex flex-col gap-2" onMouseEnter={() => setIsVideoPlaying(true)} onMouseLeave={() => setIsVideoPlaying(false)}>
        <a href={`/watch?v=${id}`} className="relative aspect-video">
            ...
            <div className="absolute bottom-1 right-1 bg-gray-700 text-white text-sm px-0.5 rounded">
        ...
        <div className="flex gap-2">
            ...
            <div className="flex flex-col">
                ...
                <a href={`/watch?v=${channel.id}`} className="text-gray-400 text-sm">{channel.name}</a>
